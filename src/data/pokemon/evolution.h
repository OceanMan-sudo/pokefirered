const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_POLIWAG]    = {{EVO_LEVEL, 18, SPECIES_POLIWHIRL}},
    ...
    [SPECIES_GEODUDE]    = {{EVO_LEVEL, 18, SPECIES_GRAVELER}},
    [SPECIES_GRAVELER]   = {{EVO_LEVEL, 38, SPECIES_GOLEM}},
    [SPECIES_PONYTA]     = {{EVO_LEVEL, 28, SPECIES_RAPIDASH}},
    [SPECIES_SLOWPOKE]   = {{EVO_LEVEL, 32, SPECIES_SLOWBRO},
    ...
    [SPECIES_GASTLY]     = {{EVO_LEVEL, 24, SPECIES_HAUNTER}},
    ...
    [SPECIES_HORSEA]     = {{EVO_LEVEL, 22, SPECIES_SEADRA}},
    ...
    [SPECIES_SLUGMA]     = {{EVO_LEVEL, 33, SPECIES_MAGCARGO}},
